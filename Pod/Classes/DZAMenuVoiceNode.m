...
+(DZAMenuVoiceNode *)buttonWithImageNamed:(NSString *)image
{
    DZAMenuVoiceNode *newButton = [[DZAMenuVoiceNode alloc]initWithImageNamed:image];
    
    return newButton;
}

+(DZAMenuVoiceNode *)buttonWithColor:(SKColor *)color andSize:(CGSize)size
{
    DZAMenuVoiceNode *newButton = [[DZAMenuVoiceNode alloc]initWithColor:color size:size];
    
    return newButton;
}

+(DZAMenuVoiceNode *)buttonWithTexture:(SKTexture *)texture andSize:(CGSize)size
{
    DZAMenuVoiceNode *newButton = [[DZAMenuVoiceNode alloc]initWithTexture:texture color:[SKColor whiteColor] size:size];
    
    return newButton;
}

+(DZAMenuVoiceNode *)buttonWithTexture:(SKTexture *)texture
{
    DZAMenuVoiceNode *newButton = [[DZAMenuVoiceNode alloc]initWithTexture:texture];
